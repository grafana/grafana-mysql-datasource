...
Thank you for your interest in contributing to the MySQL data source for Grafana! We welcome contributions from the community.

Feel free to [browse open issues](https://github.com/grafana/grafana-mysql-datasource/issues) or open a new one. For more general guidance, see [Grafana's Contributing Guide](https://github.com/grafana/grafana/blob/main/CONTRIBUTING.md).
...
`npm run server` starts a local MySQL instance and a Grafana instance with the plugin pre-provisioned:
